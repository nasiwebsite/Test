$(".link-lightbox").on("click", function() {
    ...
    var b = '<iframe src="" width="640" height="480" id="mediaplayer" style="border:0;"></iframe>',
        ...
        i = "</div></div></div></div>";
    if ($("body").append(g + f + e + d + c + b + h+i), $("#window").hide(), "youtube" == $(this).data("videosite")) var i = "http://www.blogger.com/video-play.mp4?contentId=" + $(this).data("videoid")";
    $("#window").fadeIn(), $("#mediaplayer").attr("src", i), $("#close-icon").on("click", function() {
